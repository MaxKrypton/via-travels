...
exports.tourismEntriesBatch3 = void 0;
exports.seedBatch3 = seedBatch3;
...
// ---------------------------------------------------------------------------
exports.tourismEntriesBatch3 = [
    // --- VOLCANOES NATIONAL PARK -----------------------------------------
    {
        category: 'permit',
        name: 'Mountain Gorilla Trekking Permit',
        description: 'Official RDB permit for mountain gorilla trekking in Volcanoes National Park. Includes ' +
        ...
        pricingDetails: {
            ...
            promotionalNote: 'The 200/500 USD rates for Rwandan/EAC and other African visitors are promotional rates ' +
            ...
            notes: 'priceUSD ($1500) reflects the foreigner/non-resident adult rate, the rate that applies ' +
    ...
    // --- AKAGERA NATIONAL PARK --------------------------------------------
    {
        ...
        description: 'Self-drive entry permit for Akagera National Park, tiered by residency and by number of ' +
        ...
        pricingDetails: {
            ...
            groupDiscount: 'Groups of 20+ Rwandan Nationals get an automatic 20% off: 12,000 RWF/adult, 8,000 RWF/child ' +
                '(this is a flat group rate, not a 20% reduction applied to the per-night table above).',
            notes: 'Children 5 and under: free, no entry or activity fees. Vehicle fee (separate from entry): ' +
    ...
    },
    {
        ...
        description: 'Bookable activities inside Akagera National Park, on top of the entry permit and vehicle ' +
    ...
    // --- NYUNGWE NATIONAL PARK --------------------------------------------
    {
        ...
        description: 'Entry permit for Nyungwe National Park, tiered by residency and by number of nights ' +
        ...
        pricingDetails: {
            ...
            groupDiscount: 'Groups of 20+ Rwandan Nationals: automatic 20% off; 8,000 RWF/adult, 4,000 RWF/child flat rate.',
            notes: 'Children 5 and under: free. International adult/child rates are listed as "non-commissionable." ' +
    ...
    },
    {
        ...
        description: 'Bookable activities inside Nyungwe on top of the park entry permit: chimpanzee trekking, ' +
        ...
        pricingDetails: {
            ...
            notes: 'For multi-day walking trails, an extra 15,000 RWF applies for a guide\'s (and separately, a ' +
    ...
    },
    {
        ...
        description: 'Park-run guest house at the Gisovu entrance to Nyungwe National Park, with per-person ' +
    ...
    },
    {
        ...
        description: 'Park-run guest house at Uwinka, Nyungwe\'s central reception area where most trail and ' +
    ...
    },
    {
        ...
        description: 'A guided three-day, two-night trail package through Nyungwe with a dedicated guide, ' +
        ...
        pricingDetails: {
            ...
            notes: 'Includes 1 guide. Excludes park entry fees. Meals included: dinner (days 1&2), breakfast ' +
    ...
    // --- TRANSPORT ---------------------------------------------------------
    {
        ...
        description: 'Official RURA fixed-fare bus network within Kigali, organized into 7 corridors (A-G) ' +
        ...
        pricingDetails: {
            ...
            notes: 'priceRWF (307) is shown as a representative single-fare example, not an average — fares ' +
    ...
    },
    {
        ...
        description: 'Curated subset of the official RURA intercity tariff (effective 6 April 2026), covering ' +
        ...
        pricingDetails: {
            ...
            notes: 'This replaces the March 2024 intercity tariff with the more current April 2026 figures — ' +
    ...
    // no pricing of its own.
    {
        ...
        description: 'Upper-range international hotel in Nyarugenge, 15 minutes from Kanombe International ' +
    ...
    },
    {
        ...
        description: 'Historic upper-range hotel in central Kigali, internationally known for sheltering ' +
    ...
    },
    {
        ...
        description: 'Upper-range hotel in Kacyiru with restaurant, swimming pool, tennis court, and mini-golf. ' +
            'Room rates below are from an undated historical source — verify current rates directly ' +
            'before quoting.',
    ...
    },
    {
        ...
        description: 'Mid-range hotel in Remera with bar/restaurant and DDP (dinner, bed & breakfast) option. ' +
    ...
    },
    {
        category: 'accommodation',
        name: 'Hotel Isimbi',
        description: 'Budget hotel in central Kigali. Confirmed as a currently RDB-graded 3-star Town Hotel as ' +
    ...
    },
    {
        category: 'accommodation',
        name: 'Gorilla Hotel',
        description: 'Mid-range hotel in the Kiyovu residential suburb with international restaurant/bar and ' +
    ...
    },
    {
        category: 'accommodation',
        name: 'Centre Isano',
        description: 'Lower-range guest house in Gikondo/Mburabuturo, 10 minutes from Kigali Serena Hotel. ' +
    ...
    // than guessed, since cost is usually operator- or activity-dependent here.
    {
        ...
        description: 'A 227km scenic trail running along the Lake Kivu shoreline through Rutsiro, Karongi, and ' +
    ...
    },
    {
        ...
        description: 'Natural hot springs about 7km from Gisenyi town center on the way to Kigufi, thought to ' +
    ...
    },
    {
        category: 'attraction',
        name: 'Gisenyi Beach',
        description: 'Sometimes called "the St Tropez of Africa," a tropical beach lined with palm trees along ' +
    ...
    },
    {
        ...
        description: '"From crop to cup" coffee tour on volcanic soils at 1,450-1,800m altitude, where the ' +
    ...
    },
    {
        ...
        description: 'A pottery project run by the indigenous Batwa community (about 33,000 remain in Rwanda, ' +
...
function seedBatch3() {
    return __awaiter(this, void 0, void 0, function* () {
        const inserted = yield database_1.database.insert(schema_1.tourismEntries).values(exports.tourismEntriesBatch3).returning();
